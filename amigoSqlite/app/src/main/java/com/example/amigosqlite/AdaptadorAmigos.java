...
public class AdaptadorAmigos extends BaseAdapter {
    ...
    public AdaptadorAmigos(Context contex, ArrayList<Amigos> alAmigos) {
        this.contex = contex;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            tempVal = itemView.findViewById(R.id.lblTelefonoeAdaptador);
            ...
            Toast.makeText(contex, "Error: "+ e.getMessage(), Toast.LENGTH_LONG).show();
        }
        return itemView;
    }
}
